...
export const metadata: Metadata = {
  title: "Professional Photography Studio | Weddings & Portraits",
  description: "Award-winning photographer capturing life's precious moments. Specializing in weddings, portraits, and events with artistic vision and technical excellence.",
  keywords: "photographer, wedding photography, portrait photography, event photography, professional photographer, photography studio",
  ...
  openGraph: {
    ...
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/7205899/pexels-photo-7205899.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Professional Photography Studio | Weddings & Portraits",
    description: "Award-winning photographer capturing life's precious moments. Specializing in weddings, portraits, and events with artistic vision and technical excellence.",
    images: ["https://images.pexels.com/photos/7205899/pexels-photo-7205899.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
